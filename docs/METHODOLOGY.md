...
**For aXIOM:** The Academic Assessor tool is the research output. Its construction, evaluation, and refinement generate design knowledge about AI-assisted academic assessment.
...
**Core principle:** Before designing interventions, understand the practice from within. The *Lebenswelt* (lived experience) of faculty members — how they actually think about and conduct assessment — is the epistemological foundation of the design.

**For aXIOM:** The Discovery phase is not "user research" — it is empirical research with defined epistemological status. The requirement schema emerges from observed assessment practice, not from external standards imposed top-down.
...
This is not unusual in human-centered computing and participatory design research. It resolves a specific problem for aXIOM: DSR alone cannot justify *why* a schema-based approach is the right intervention. Phenomenological grounding provides that justification — the schema reflects *how faculty actually think about assessment*, not an arbitrary external framework.
...
In qualitative and cultural research, *Nachvollziehbarkeit* is a quality criterion — can another researcher follow your reasoning? Can you trace claims back to evidence? aXIOM applies this principle to academic assessment: can a student understand *why* they received certain feedback? Can faculty members discuss *how* they arrived at an evaluation?
...
The following methodological questions require resolution before academic publication:

1. **Epistemological position** (addressed above — interpretively grounded DSR)
2. **Discovery phase status** (addressed above — three options, not yet chosen)
3. **Validation logic** — How will we know the tool "works"? Not technically — methodologically. What counts as evidence of validity in a PoC framing?

**Question 3 is unresolved and requires dedicated analysis.**
...
**Implication:** The analytical engine is a **proof of concept**, not a validated scientific methodology. This framing absorbs the "scholarly isolation" finding (no comparable tools exist) without requiring full validation at this stage.
