...
>
> **For agents:** consult `STATUS.md` before suggesting changes to
...
> `STATUS.md`). The list below applied to the phase-1 scope when the
> phase-1 scope itself was active.
